    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Identical Master Shield", Description = "An awesome identical Stainless Steel Shield", Force = 11, Image = "https://publicdomainvectors.org/photos/Shield-ClassicMedieval1.png", Price = 501, Qty = 60, QtyBought = 2, CreatedDate = new DateTime(2026, 09, 16) }
            );
            #endregion
        }
    }
